...
import { Delete, Mic } from "../../../public/svg";

interface AnnounceDeleteProps {
  open: boolean;
  title?: string;
  onConfirm: () => void;
  onCancel: () => void;
...
export default function AnnounceDelete({ open, title, onConfirm, onCancel }: AnnounceDeleteProps) {
  if (!open) return null;
